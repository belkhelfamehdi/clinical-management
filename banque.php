    ...
    <div class="container">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <h1 class="titre">banque de sang </h1>
            ...
            <div class="cardBox">
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?php ini_set('display_errors', 0); include 'connect.php' ;
                            $str = "SELECT * FROM `donneur`";
                            $result = mysqli_query($conn, $str);
                            echo mysqli_num_rows($result);
                            ?></div>
                        <div class="cardName"> information donneur</div>
                    </div>
                ...
                <a href="stockSang.php">
                <div class="card">
                    
                    <div>
                        <div class="numbers"><?php include 'connect.php' ;
                            $str = "SELECT * FROM `stocks`";
                            $result = mysqli_query($conn, $str);
                            echo mysqli_num_rows($result);
                            ?></div>
                        <div class="cardName"> stock de sang </div>
                    </div>
