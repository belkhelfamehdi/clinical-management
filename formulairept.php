            ...
            <section class="signup">
                <div class="container">
                    <div class="signup-content">
                        <form method="POST" action="ajouterpt.php" id="signup-form" class="signup-form"
                            style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-input" name="daten" id="daten"
                                    placeholder="Date de naissance" required />
                            </div>
                            <span class="dropdown-el" style="margin-left : 10%; position : absolute;">
                                <input type="radio" name="gen" value="Homme" id="sort-relevance"
                                    style="margin: 0 10px 0 10px;"><label for="sort-relevance">Homme</label>
                                <input type="radio" name="gen" value="Femme" id="sort-best"
                                    style="margin: 0 10px 0 150px;"><label for="sort-best">Femme</label>
                            </span>
                            <br><br>
                            <div class="form-group">
                                <input type="number" class="form-input" name="num" id="num" placeholder="Numéro"
                                    required />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-input" name="addr" id="addr" placeholder="addresse"
                                    required />
                            </div>
