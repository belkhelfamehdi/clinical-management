    ...
    <div class="container">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div>
                    <h1 class="titre">Modifier un Salaire</h1>
                </div>
                ...
                <div class="signup-content">
                    <form method="POST" action="#" id="signup-form" class="signup-form" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="nom" id="name" placeholder="Nom" value= <?php echo $nom ?> disabled required/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="prenom" id="Prenom" placeholder="Prénom" value= <?php echo $prenom ?> disabled required/>
                        </div>
                        <div class="form-group">
