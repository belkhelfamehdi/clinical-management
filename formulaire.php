    ...
    <div class="container">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="user">
                    <img src="assets/imgs/medicale.jpg" alt="">
                </div>
            </div>
            <!-- ======================= formulaire================== -->
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action="ajouter.php" id="signup-form" class="signup-form" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
              ...
              <br><br>
                        <div class="form-group">
                            <input type="number" class="form-input" name="num" id="num" placeholder="Numéro" required/>
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-input" name="email" id="email" placeholder="Email" required minlength="9"/>
                        </div>
