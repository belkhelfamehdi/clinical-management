...
<?php
        ...
        if(isset($_POST['submit'])){
            ...
            // checking empty fields    
                //updating the table
                $requete = "UPDATE `medicament` SET `numM`='$nom',`nom`='$prenom',`quantite`='$daten' WHERE numM = '$nom'";
    ...
    <div class="navigation">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div>
                    <h1 class="titre">Modifier un medicament</h1>
                </div>
                ...
                <div class="signup-content">
                    <form method="POST" action="#" id="signup-form" class="signup-form" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="num" id="num" placeholder="Numéro du médicament" value=<?php echo $nom ?> required/>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="nom" id="nom" placeholder="Nom du médicament" value=<?php echo $prenom ?> required/>
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-input" name="qt" id="qt" placeholder="Quantité" value=<?php echo $daten ?> required/>
                        </div>
                        <div class="form-group">
