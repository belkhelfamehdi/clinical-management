...
<body>
        ...
        if(isset($_POST['submit'])){
          ...
          $gs = $_POST['gp'];
            ...
            // checking empty fields    
                //updating the table
                $requete = "UPDATE `donneur` SET `nom`='$nom',`prenom`='$prenom',`numero`='$num',`gs`='$gs' WHERE id = '$id'";
    ...
    <div class="navigation">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div>
                    <h1 class="titre">Modifier un donneur</h1>
                </div>
                ...
                <div class="signup-content">
                    <form method="POST" action="#" id="signup-form" class="signup-form" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="nom" id="name" placeholder="Nom" value= <?php echo $nom ?>  />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="prenom" id="Prenom" placeholder="Prénom" value= <?php echo $prenom ?>  />
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-input" name="num" id="num" placeholder="Numéro" value= <?php echo $num ?>  />
                        </div>
  ...
  <div class="list-choice-objects">
      ...
      ?>
    <label>
      <input type="radio" name="gp" id="A+" value="A+" checked  />                         <span>A+</span>
    </label>
    <label>
      <input type="radio" name="gp" id="A-"  value="A-"  />                         <span>A-</span>
    </label>
    <label>
      <input type="radio" name="gp" id="B+" value="B+"  />                         <span>B+</span>
    </label>
    <label>
      <input type="radio" name="gp" id="B-" value="B-"  />                         <span>B-</span>
    </label>
    <label>
      <input type="radio" name="gp" id="AB+" value="AB+"  />                         <span>AB+</span>
    </label>
    <label>
      <input type="radio" name="gp" id="AB-" value="AB-"  />                         <span>AB-</span>
    </label>
    <label>
      <input type="radio" name="gp" id="O+" value="O+"  />                         <span>O+</span>
    </label>
    <label>
      <input type="radio" name="gp" id="O-" value="O-"  />                         <span>O-</span>
    </label>
    <?php
            ...
            <label>
              <input type="radio" name="gp" id="B+" value="B+" checked  />                         <span>B+</span>
            </label>
            <label>
              <input type="radio" name="gp" id="B-" value="B-"  />                         <span>B-</span>
            </label>
            ...
            <label>
              <input type="radio" name="gp" id="AB+" value="AB+" checked  />                         <span>AB+</span>
            </label>
            <label>
              <input type="radio" name="gp" id="AB-" value="AB-"  />                         <span>AB-</span>
            </label>
            ...
            <label>
              <input type="radio" name="gp" id="O+" value="O+" checked  />                         <span>O+</span>
            </label>
            <label>
              <input type="radio" name="gp" id="O-" value="O-"  />                         <span>O-</span>
            </label>
