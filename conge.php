        ...
        <div class="main">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action="pc.php?=<?php  echo $id ?>" id="signup-form" class="signup-form" style="box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); -webkit-border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; border-radius: 20px 20px 20px 20px; width :60%; justify-content: center; margin-left: 21%; padding-top: 18px;">
                        <h2 class="form-title">Prendre un congé</h2>
                        <input type="text" class="form-input" name="hidden" id="name" placeholder="Nom" value= <?php echo $id ?>  style="display: none;"/>
                        ...
                        <div class="form-group">
                          <label for="daten">Début de congé :</label>
                            <input type="date" class="form-input" name="daten" id="daten" placeholder="Date de naissance" required/>
                        </div>
                        <div class="form-group">
                          <label for="dateem">Fin de congé :</label>
                            <input type="date" class="form-input" name="dateem" id="dateem" placeholder="Date d'embauche" required/>
                        </div>
                        <div class="form-group">
